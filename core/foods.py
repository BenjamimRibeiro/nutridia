...
_CAT_EN = {
    "Pão e cereais": "Bread & cereals", "Carne": "Meat", "Peixe": "Fish", "Lacticínios": "Dairy",
...
_NOMES_EN = {
    ...
    "Cação": "Dogfish", "Amêijoas": "Clams", "Ostras": "Oysters",
    "Fiambre de frango": "Chicken ham", "Fiambre de porco": "Pork ham",
    "Salsichas de porco": "Pork sausages", "Salsichas de ave": "Poultry sausages",
    ...
    "Abóbora": "Pumpkin", "Curgete": "Courgette", "Pepino": "Cucumber",
...
CATEGORIAS = [
    "Pão e cereais", "Carne", "Peixe", "Lacticínios", "Leguminosas", "Sopas e pratos",
...
ALIMENTOS = [
    ...
    # ---------- Carne (e ovo) ----------
    _f("Ovo", "Carne", [("1 ovo M", 55), ("1 ovo L", 65), ("2 ovos", 120)],
    ...
    _f("Peito de frango grelhado", "Carne", [("1 peito pequeno", 120), ("Bife", 150)],
    ...
    _f("Bife de peru", "Carne", [("1 bife", 120), ("Bife grande", 150)],
       kcal=150, proteina_g=29, gordura_g=3, gordura_saturada_g=1, sodio_mg=60, potassio_mg=250,
       magnesio_mg=28, zinco_mg=1.7, ferro_mg=1.2, vit_b3_mg=10, vit_b6_mg=0.7, vit_b12_ug=1.3),
    _f("Bife de vaca", "Carne", [("Bife", 150)],
    ...
    _f("Carne de porco (lombo)", "Carne", [("Bife", 130)],
    ...
    _f("Hambúrguer de vaca", "Carne", [("1 hambúrguer", 100), ("1 hambúrguer grande", 150)],
    ...
    _f("Hambúrguer de porco", "Carne", [("1 hambúrguer", 100), ("1 hambúrguer grande", 150)],
    ...
    _f("Fiambre de frango", "Carne", [("1 fatia", 20), ("2 fatias", 40)],
       kcal=110, proteina_g=18, gordura_g=3.5, gordura_saturada_g=1, sodio_mg=950, ferro_mg=0.8),
    _f("Fiambre de porco", "Carne", [("1 fatia", 20), ("2 fatias", 40)],
    ...
    _f("Salsichas de porco", "Carne", [("1 salsicha", 45), ("2 salsichas", 90)],
       kcal=290, proteina_g=12, gordura_g=26, gordura_saturada_g=9.5, sodio_mg=950, ferro_mg=1,
       zinco_mg=1.5, vit_b12_ug=0.8),
    _f("Salsichas de ave", "Carne", [("1 salsicha", 45), ("2 salsichas", 90)],
       kcal=230, proteina_g=14, gordura_g=18, gordura_saturada_g=5, sodio_mg=900, ferro_mg=0.9,
       zinco_mg=1.2, vit_b12_ug=0.6),
    # ---------- Peixe (e marisco) ----------
    _f("Salmão", "Peixe", [("Posta", 130)],
    ...
    _f("Atum em água (lata)", "Peixe", [("1 lata escorrida", 80)],
    ...
    _f("Cação", "Peixe", [("Posta", 150)],
       kcal=130, proteina_g=23, gordura_g=4, gordura_saturada_g=0.9, omega3_g=0.5, sodio_mg=90,
       potassio_mg=400, magnesio_mg=30, ferro_mg=0.8, vit_d_ug=1, vit_b12_ug=2),
    _f("Camarão", "Peixe", [("Porção", 100)],
       kcal=99, proteina_g=24, gordura_g=0.3, sodio_mg=111, calcio_mg=70, ferro_mg=0.5,
       zinco_mg=1.6, vit_b12_ug=1.1),
    _f("Amêijoas", "Peixe", [("Porção", 100), ("Dose", 150)],
       kcal=86, proteina_g=15, gordura_g=1, omega3_g=0.2, sodio_mg=90, potassio_mg=314,
       ferro_mg=14, zinco_mg=1.4, magnesio_mg=15, vit_b12_ug=25, vit_c_mg=13, agua_ml=80),
    _f("Ostras", "Peixe", [("Meia dúzia", 90)],
       kcal=80, proteina_g=9, gordura_g=2.3, omega3_g=0.7, sodio_mg=200, potassio_mg=200,
       ferro_mg=5, zinco_mg=16, magnesio_mg=22, vit_d_ug=8, vit_b12_ug=16, agua_ml=80),
    ...
    _f("Abóbora", "Vegetais", [("Porção", 100), ("Chávena aos cubos", 120)],
       kcal=26, proteina_g=1, hidratos_g=6.5, fibra_g=0.5, acucar_g=2.8, vit_a_ug=426, vit_c_mg=9,
       potassio_mg=340, magnesio_mg=12, agua_ml=91),
    _f("Curgete", "Vegetais", [("Meia curgete", 100), ("Acompanhamento", 150)],
       kcal=17, proteina_g=1.2, hidratos_g=3.1, fibra_g=1, vit_c_mg=17, vit_a_ug=10,
       potassio_mg=261, magnesio_mg=18, folato_ug=24, agua_ml=95),
    _f("Pepino", "Vegetais", [("Porção (rodelas)", 100), ("Meio pepino", 150)],
       kcal=15, proteina_g=0.7, hidratos_g=3.6, fibra_g=0.5, vit_c_mg=2.8, vit_k_ug=16,
       potassio_mg=147, magnesio_mg=13, agua_ml=95),
